...
{
    public static async UniTask LerpObjectToAnother(this Transform objectToLerp, Transform objectToLerpTo,
        float lerpDuration, bool shouldParent = false, CancellationToken cancellationToken = default)
    {
        float passedTime = 0;
    ...
    public static void SetPositionOrLocalPosition(this Transform objectToTransform, Vector3 targetPosition,
        bool localPosition)
    {
        if (localPosition)
        {
    ...
    public static async UniTask LerpObjectToPosition(this Transform objectToLerp, Vector3 targetPosition,
        float lerpDuration, bool localPosition = true, CancellationToken cancellationToken = default)
    {
        float passedTime = 0;
    ...
    public static async UniTask LerpObjectToRotation(this Transform objectToLerp, Vector3 targetRotation,
        float lerpDuration, bool localRotation = true, CancellationToken cancellationToken = default)
    {
        float passedTime = 0;
    ...
    public static void SetRotationOrLocalRotation(this Transform objectToTransform, Vector3 targetRotation,
        bool localRotation)
    {
        if (localRotation)
        {
